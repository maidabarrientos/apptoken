/**
 *  ZIP ZIP coin contract, ERC20 compliant (see https://github.com/ethereum/EIPs/issues/20)
 *
...
contract ZIP is ERC20TokenInterface {
  ...
  //// Constants ////
  string public constant name = 'ZIP';
  ...
  //// Public functions ////
  function Zipcoin(address _migrationInfoSetter) {
